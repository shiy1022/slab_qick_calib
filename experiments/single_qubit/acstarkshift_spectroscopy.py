...
class ACStarkShiftProgram(RAveragerProgram):
    def initialize(self):
        ...
        self.qubit_length_dac = self.us2cycles(
            cfg.expt.qubit_length, gen_ch=self.qubit_ch
        )
        ...
        self.f_start = self.freq2reg(
            cfg.expt.start, gen_ch=self.qubit_ch
        )  # get start/step frequencies for qubit spec
    ...
    def body(self):
        ...
        self.pulse(
            ch=self.qubit_ch, t=self.pump_length_dac - self.qubit_length_dac
        )  # play qubit pulse at end of pump tone
...
class ACStarkShiftPulseProbeExperiment(Experiment):
    ...
    def acquire(self, progress=False, debug=False):
        ...
        for gain in tqdm(gainpts):
            ...
            freqpts, avgi, avgq = acspec.acquire(
    ...
    def display(self, data=None, fit=True, **kwargs):
        ...
        plt.subplot(
            211,
            title=f"Qubit {self.cfg.expt.qubit} AC Stark Shift (Pump Freq {self.cfg.expt.pump_freq} MHz)",
