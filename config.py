...
def init_config(file_name, num_qubits, aliases='Qick001'):
    ...
    device['qubit']['f_ge']= [3300]*num_qubits
    device['qubit']['f_EgGf']= [2000]*num_qubits
    device['qubit']['f_ef']= [3000]*num_qubits
    ...
    device['qubit']['pulses']['hpi_ge']['type']= ['gauss']*num_qubits
    device['qubit']['pulses']['pi_ge']['gain']= [1000]*num_qubits
    ...
    device['qubit']['pulses']['pi_ef']['gain']= [10000]*num_qubits
    ...
    device['readout']['gain']= [15000]*num_qubits
    ...
    soc = {'adcs':{'readout':{'ch':[0]*num_qubits}}, 'dacs':{'qubit':{'ch': [0]*num_qubits, 'nyquist':[2]*num_qubits, 'type':['full']*num_qubits}, 'readout':{'ch': [0]*num_qubits, 'nyquist':[2]*num_qubits, 'type':['full']*num_qubits}}}
